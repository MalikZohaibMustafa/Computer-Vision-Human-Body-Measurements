...
#        self.config = config
        ...
        self.load_path = 'ModelFiles/models/model.ckpt-667589'#config.load_path
...
#            ipdb.set_trace()
        ...
        self.smpl_model_path = 'ModelFiles/models/neutral_smpl_with_cocoplus_reg.pkl'#config.smpl_model_path
